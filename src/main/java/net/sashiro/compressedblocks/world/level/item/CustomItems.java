...
public class CustomItems {
    ...
    public static ArrayList<RegistryObject<Item>> RAW_MUTTON = new ArrayList<>();
    ...
    public static void populate() {
        ...
        CRATE_ITEMS.add("raw_porkchop");
        CRATE_ITEMS.add("cooked_porkchop");
        CRATE_ITEMS.add("raw_cod");
        CRATE_ITEMS.add("raw_salmon");
        ...
        CRATE_ITEMS.add("raw_beef");
        CRATE_ITEMS.add("cooked_beef");
        CRATE_ITEMS.add("raw_chicken");
        ...
        MUSHROOM_STEW.add(0, RegistryObject.of(Items.MUSHROOM_STEW.getRegistryName(), ForgeRegistries.ITEMS));
        BREAD.add(0, RegistryObject.of(Items.BREAD.getRegistryName(), ForgeRegistries.ITEMS));
        RAW_PORKCHOP.add(0, RegistryObject.of(Items.PORKCHOP.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_PORKCHOP.add(0, RegistryObject.of(Items.COOKED_PORKCHOP.getRegistryName(), ForgeRegistries.ITEMS));
        RAW_COD.add(0, RegistryObject.of(Items.COD.getRegistryName(), ForgeRegistries.ITEMS));
        RAW_SALMON.add(0, RegistryObject.of(Items.SALMON.getRegistryName(), ForgeRegistries.ITEMS));
        TROPICAL_FISH.add(0, RegistryObject.of(Items.TROPICAL_FISH.getRegistryName(), ForgeRegistries.ITEMS));
        PUFFERFISH.add(0, RegistryObject.of(Items.PUFFERFISH.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_COD.add(0, RegistryObject.of(Items.COOKED_COD.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_SALMON.add(0, RegistryObject.of(Items.COOKED_SALMON.getRegistryName(), ForgeRegistries.ITEMS));
        CAKES.add(0, RegistryObject.of(Items.CAKE.getRegistryName(), ForgeRegistries.ITEMS));
        COOKIES.add(0, RegistryObject.of(Items.COOKIE.getRegistryName(), ForgeRegistries.ITEMS));
        MELON_SLICES.add(0, RegistryObject.of(Items.MELON_SLICE.getRegistryName(), ForgeRegistries.ITEMS));
        MELON_SEEDS.add(0, RegistryObject.of(Items.MELON_SEEDS.getRegistryName(), ForgeRegistries.ITEMS));
        DRIED_KELP.add(0, RegistryObject.of(Items.DRIED_KELP.getRegistryName(), ForgeRegistries.ITEMS));
        RAW_BEEF.add(0, RegistryObject.of(Items.BEEF.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_BEEF.add(0, RegistryObject.of(Items.COOKED_BEEF.getRegistryName(), ForgeRegistries.ITEMS));
        RAW_CHICKEN.add(0, RegistryObject.of(Items.CHICKEN.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_CHICKEN.add(0, RegistryObject.of(Items.COOKED_CHICKEN.getRegistryName(), ForgeRegistries.ITEMS));
        ROTTEN_FLESH.add(0, RegistryObject.of(Items.ROTTEN_FLESH.getRegistryName(), ForgeRegistries.ITEMS));
        ...
        BAKED_POTATOES.add(0, RegistryObject.of(Items.BAKED_POTATO.getRegistryName(), ForgeRegistries.ITEMS));
        POISONOUS_POTATOES.add(0, RegistryObject.of(Items.POISONOUS_POTATO.getRegistryName(), ForgeRegistries.ITEMS));
        PUMPKIN_PIES.add(0, RegistryObject.of(Items.PUMPKIN_PIE.getRegistryName(), ForgeRegistries.ITEMS));
        RAW_RABBIT.add(0, RegistryObject.of(Items.RABBIT.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_RABBIT.add(0, RegistryObject.of(Items.COOKED_RABBIT.getRegistryName(), ForgeRegistries.ITEMS));
        RABBIT_STEW.add(0, RegistryObject.of(Items.RABBIT_STEW.getRegistryName(), ForgeRegistries.ITEMS));
        RAW_MUTTON.add(0, RegistryObject.of(Items.MUTTON.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_MUTTON.add(0, RegistryObject.of(Items.COOKED_MUTTON.getRegistryName(), ForgeRegistries.ITEMS));
        ...
        BEETROOT_SOUP.add(0, RegistryObject.of(Items.BEETROOT_SOUP.getRegistryName(), ForgeRegistries.ITEMS));
        SWEET_BERRIES.add(0, RegistryObject.of(Items.SWEET_BERRIES.getRegistryName(), ForgeRegistries.ITEMS));
        GLOW_BERRIES.add(0, RegistryObject.of(Items.GLOW_BERRIES.getRegistryName(), ForgeRegistries.ITEMS));
        EGGS.add(0, RegistryObject.of(Items.EGG.getRegistryName(), ForgeRegistries.ITEMS));
        SUGAR_CANES.add(0, RegistryObject.of(Items.SUGAR_CANE.getRegistryName(), ForgeRegistries.ITEMS));
        SUGAR.add(0, RegistryObject.of(Items.SUGAR.getRegistryName(), ForgeRegistries.ITEMS));
        PUMPKINS.add(0, RegistryObject.of(Items.PUMPKIN.getRegistryName(), ForgeRegistries.ITEMS));
        PUMPKIN_SEEDS.add(0, RegistryObject.of(Items.PUMPKIN_SEEDS.getRegistryName(), ForgeRegistries.ITEMS));
        WHEAT.add(0, RegistryObject.of(Items.WHEAT.getRegistryName(), ForgeRegistries.ITEMS));
        WHEAT_SEEDS.add(0, RegistryObject.of(Items.WHEAT_SEEDS.getRegistryName(), ForgeRegistries.ITEMS));
        COCOA_BEANS.add(0, RegistryObject.of(Items.COCOA_BEANS.getRegistryName(), ForgeRegistries.ITEMS));
        ...
        FERMENTED_SPIDER_EYES.add(0, RegistryObject.of(Items.FERMENTED_SPIDER_EYE.getRegistryName(), ForgeRegistries.ITEMS));
        ...
        MAGMA_CREAM.add(0, RegistryObject.of(Items.MAGMA_CREAM.getRegistryName(), ForgeRegistries.ITEMS));
        BONES.add(0, RegistryObject.of(Items.BONE.getRegistryName(), ForgeRegistries.ITEMS));
        BONE_MEAL.add(0, RegistryObject.of(Items.BONE_MEAL.getRegistryName(), ForgeRegistries.ITEMS));
        ...
        INK_SACS.add(0, RegistryObject.of(Items.INK_SAC.getRegistryName(), ForgeRegistries.ITEMS));
        GLOW_INK_SACS.add(0, RegistryObject.of(Items.GLOW_INK_SAC.getRegistryName(), ForgeRegistries.ITEMS));
        STICKS.add(0, RegistryObject.of(Items.STICK.getRegistryName(), ForgeRegistries.ITEMS));
        GLASS_BOTTLES.add(0, RegistryObject.of(Items.GLASS_BOTTLE.getRegistryName(), ForgeRegistries.ITEMS));
        SNOWBALLS.add(0, RegistryObject.of(Items.SNOWBALL.getRegistryName(), ForgeRegistries.ITEMS));
        PAPER.add(0, RegistryObject.of(Items.PAPER.getRegistryName(), ForgeRegistries.ITEMS));
        FLINTS.add(0, RegistryObject.of(Items.FLINT.getRegistryName(), ForgeRegistries.ITEMS));
        OAK_SAPLINGS.add(0, RegistryObject.of(Items.OAK_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        SPRUCE_SAPLINGS.add(0, RegistryObject.of(Items.SPRUCE_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        BIRCH_SAPLINGS.add(0, RegistryObject.of(Items.BIRCH_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        JUNGLE_SAPLINGS.add(0, RegistryObject.of(Items.JUNGLE_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        ACACIA_SAPLINGS.add(0, RegistryObject.of(Items.ACACIA_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        DARK_OAK_SAPLINGS.add(0, RegistryObject.of(Items.DARK_OAK_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        CHORUS_FRUITS.add(0, RegistryObject.of(Items.CHORUS_FRUIT.getRegistryName(), ForgeRegistries.ITEMS));
        SEAGRASS.add(0, RegistryObject.of(Items.SEAGRASS.getRegistryName(), ForgeRegistries.ITEMS));
        KELP.add(0, RegistryObject.of(Items.KELP.getRegistryName(), ForgeRegistries.ITEMS));
        BAMBOO.add(0, RegistryObject.of(Items.BAMBOO.getRegistryName(), ForgeRegistries.ITEMS));
        BROWN_MUSHROOMS.add(0, RegistryObject.of(Items.BROWN_MUSHROOM.getRegistryName(), ForgeRegistries.ITEMS));
        RED_MUSHROOMS.add(0, RegistryObject.of(Items.RED_MUSHROOM.getRegistryName(), ForgeRegistries.ITEMS));
        CRIMSON_FUNGUS.add(0, RegistryObject.of(Items.CRIMSON_FUNGUS.getRegistryName(), ForgeRegistries.ITEMS));
        WARPED_FUNGUS.add(0, RegistryObject.of(Items.WARPED_FUNGUS.getRegistryName(), ForgeRegistries.ITEMS));
        WITHER_ROSES.add(0, RegistryObject.of(Items.WITHER_ROSE.getRegistryName(), ForgeRegistries.ITEMS));
        NETHER_WARTS.add(0, RegistryObject.of(Items.NETHER_WART.getRegistryName(), ForgeRegistries.ITEMS));
    }
}
