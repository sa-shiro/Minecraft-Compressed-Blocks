...
public class CustomItems {
    ...
    public static void populate() {
        ...
        APPLES.add(0, RegistryObject.create(Items.APPLE.getRegistryName(), ForgeRegistries.ITEMS));
        MUSHROOM_STEW.add(0, RegistryObject.create(Items.MUSHROOM_STEW.getRegistryName(), ForgeRegistries.ITEMS));
        BREAD.add(0, RegistryObject.create(Items.BREAD.getRegistryName(), ForgeRegistries.ITEMS));
        PORKCHOP.add(0, RegistryObject.create(Items.PORKCHOP.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_PORKCHOP.add(0, RegistryObject.create(Items.COOKED_PORKCHOP.getRegistryName(), ForgeRegistries.ITEMS));
        COD.add(0, RegistryObject.create(Items.COD.getRegistryName(), ForgeRegistries.ITEMS));
        SALMON.add(0, RegistryObject.create(Items.SALMON.getRegistryName(), ForgeRegistries.ITEMS));
        TROPICAL_FISH.add(0, RegistryObject.create(Items.TROPICAL_FISH.getRegistryName(), ForgeRegistries.ITEMS));
        PUFFERFISH.add(0, RegistryObject.create(Items.PUFFERFISH.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_COD.add(0, RegistryObject.create(Items.COOKED_COD.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_SALMON.add(0, RegistryObject.create(Items.COOKED_SALMON.getRegistryName(), ForgeRegistries.ITEMS));
        CAKES.add(0, RegistryObject.create(Items.CAKE.getRegistryName(), ForgeRegistries.ITEMS));
        COOKIES.add(0, RegistryObject.create(Items.COOKIE.getRegistryName(), ForgeRegistries.ITEMS));
        MELON_SLICES.add(0, RegistryObject.create(Items.MELON_SLICE.getRegistryName(), ForgeRegistries.ITEMS));
        MELON_SEEDS.add(0, RegistryObject.create(Items.MELON_SEEDS.getRegistryName(), ForgeRegistries.ITEMS));
        DRIED_KELP.add(0, RegistryObject.create(Items.DRIED_KELP.getRegistryName(), ForgeRegistries.ITEMS));
        BEEF.add(0, RegistryObject.create(Items.BEEF.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_BEEF.add(0, RegistryObject.create(Items.COOKED_BEEF.getRegistryName(), ForgeRegistries.ITEMS));
        CHICKEN.add(0, RegistryObject.create(Items.CHICKEN.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_CHICKEN.add(0, RegistryObject.create(Items.COOKED_CHICKEN.getRegistryName(), ForgeRegistries.ITEMS));
        ROTTEN_FLESH.add(0, RegistryObject.create(Items.ROTTEN_FLESH.getRegistryName(), ForgeRegistries.ITEMS));
        CARROTS.add(0, RegistryObject.create(Items.CARROT.getRegistryName(), ForgeRegistries.ITEMS));
        POTATOES.add(0, RegistryObject.create(Items.POTATO.getRegistryName(), ForgeRegistries.ITEMS));
        BAKED_POTATOES.add(0, RegistryObject.create(Items.BAKED_POTATO.getRegistryName(), ForgeRegistries.ITEMS));
        POISONOUS_POTATOES.add(0, RegistryObject.create(Items.POISONOUS_POTATO.getRegistryName(), ForgeRegistries.ITEMS));
        PUMPKIN_PIES.add(0, RegistryObject.create(Items.PUMPKIN_PIE.getRegistryName(), ForgeRegistries.ITEMS));
        RABBIT.add(0, RegistryObject.create(Items.RABBIT.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_RABBIT.add(0, RegistryObject.create(Items.COOKED_RABBIT.getRegistryName(), ForgeRegistries.ITEMS));
        RABBIT_STEW.add(0, RegistryObject.create(Items.RABBIT_STEW.getRegistryName(), ForgeRegistries.ITEMS));
        MUTTON.add(0, RegistryObject.create(Items.MUTTON.getRegistryName(), ForgeRegistries.ITEMS));
        COOKED_MUTTON.add(0, RegistryObject.create(Items.COOKED_MUTTON.getRegistryName(), ForgeRegistries.ITEMS));
        BEETROOT.add(0, RegistryObject.create(Items.BEETROOT.getRegistryName(), ForgeRegistries.ITEMS));
        BEETROOT_SEEDS.add(0, RegistryObject.create(Items.BEETROOT_SEEDS.getRegistryName(), ForgeRegistries.ITEMS));
        BEETROOT_SOUP.add(0, RegistryObject.create(Items.BEETROOT_SOUP.getRegistryName(), ForgeRegistries.ITEMS));
        SWEET_BERRIES.add(0, RegistryObject.create(Items.SWEET_BERRIES.getRegistryName(), ForgeRegistries.ITEMS));
        GLOW_BERRIES.add(0, RegistryObject.create(Items.GLOW_BERRIES.getRegistryName(), ForgeRegistries.ITEMS));
        EGGS.add(0, RegistryObject.create(Items.EGG.getRegistryName(), ForgeRegistries.ITEMS));
        SUGAR_CANES.add(0, RegistryObject.create(Items.SUGAR_CANE.getRegistryName(), ForgeRegistries.ITEMS));
        SUGAR.add(0, RegistryObject.create(Items.SUGAR.getRegistryName(), ForgeRegistries.ITEMS));
        PUMPKINS.add(0, RegistryObject.create(Items.PUMPKIN.getRegistryName(), ForgeRegistries.ITEMS));
        PUMPKIN_SEEDS.add(0, RegistryObject.create(Items.PUMPKIN_SEEDS.getRegistryName(), ForgeRegistries.ITEMS));
        WHEAT.add(0, RegistryObject.create(Items.WHEAT.getRegistryName(), ForgeRegistries.ITEMS));
        WHEAT_SEEDS.add(0, RegistryObject.create(Items.WHEAT_SEEDS.getRegistryName(), ForgeRegistries.ITEMS));
        COCOA_BEANS.add(0, RegistryObject.create(Items.COCOA_BEANS.getRegistryName(), ForgeRegistries.ITEMS));
        ARROWS.add(0, RegistryObject.create(Items.ARROW.getRegistryName(), ForgeRegistries.ITEMS));
        SPIDER_EYES.add(0, RegistryObject.create(Items.SPIDER_EYE.getRegistryName(), ForgeRegistries.ITEMS));
        FERMENTED_SPIDER_EYES.add(0, RegistryObject.create(Items.FERMENTED_SPIDER_EYE.getRegistryName(), ForgeRegistries.ITEMS));
        BLAZE_RODS.add(0, RegistryObject.create(Items.BLAZE_ROD.getRegistryName(), ForgeRegistries.ITEMS));
        BLAZE_POWDER.add(0, RegistryObject.create(Items.BLAZE_POWDER.getRegistryName(), ForgeRegistries.ITEMS));
        MAGMA_CREAM.add(0, RegistryObject.create(Items.MAGMA_CREAM.getRegistryName(), ForgeRegistries.ITEMS));
        BONES.add(0, RegistryObject.create(Items.BONE.getRegistryName(), ForgeRegistries.ITEMS));
        BONE_MEAL.add(0, RegistryObject.create(Items.BONE_MEAL.getRegistryName(), ForgeRegistries.ITEMS));
        ENDER_EYES.add(0, RegistryObject.create(Items.ENDER_EYE.getRegistryName(), ForgeRegistries.ITEMS));
        ENDER_PEARLS.add(0, RegistryObject.create(Items.ENDER_PEARL.getRegistryName(), ForgeRegistries.ITEMS));
        FEATHERS.add(0, RegistryObject.create(Items.FEATHER.getRegistryName(), ForgeRegistries.ITEMS));
        LEATHER.add(0, RegistryObject.create(Items.LEATHER.getRegistryName(), ForgeRegistries.ITEMS));
        STRINGS.add(0, RegistryObject.create(Items.STRING.getRegistryName(), ForgeRegistries.ITEMS));
        INK_SACS.add(0, RegistryObject.create(Items.INK_SAC.getRegistryName(), ForgeRegistries.ITEMS));
        GLOW_INK_SACS.add(0, RegistryObject.create(Items.GLOW_INK_SAC.getRegistryName(), ForgeRegistries.ITEMS));
        STICKS.add(0, RegistryObject.create(Items.STICK.getRegistryName(), ForgeRegistries.ITEMS));
        GLASS_BOTTLES.add(0, RegistryObject.create(Items.GLASS_BOTTLE.getRegistryName(), ForgeRegistries.ITEMS));
        SNOWBALLS.add(0, RegistryObject.create(Items.SNOWBALL.getRegistryName(), ForgeRegistries.ITEMS));
        PAPER.add(0, RegistryObject.create(Items.PAPER.getRegistryName(), ForgeRegistries.ITEMS));
        FLINTS.add(0, RegistryObject.create(Items.FLINT.getRegistryName(), ForgeRegistries.ITEMS));
        OAK_SAPLINGS.add(0, RegistryObject.create(Items.OAK_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        SPRUCE_SAPLINGS.add(0, RegistryObject.create(Items.SPRUCE_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        BIRCH_SAPLINGS.add(0, RegistryObject.create(Items.BIRCH_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        JUNGLE_SAPLINGS.add(0, RegistryObject.create(Items.JUNGLE_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        ACACIA_SAPLINGS.add(0, RegistryObject.create(Items.ACACIA_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        DARK_OAK_SAPLINGS.add(0, RegistryObject.create(Items.DARK_OAK_SAPLING.getRegistryName(), ForgeRegistries.ITEMS));
        CHORUS_FRUITS.add(0, RegistryObject.create(Items.CHORUS_FRUIT.getRegistryName(), ForgeRegistries.ITEMS));
        SEAGRASS.add(0, RegistryObject.create(Items.SEAGRASS.getRegistryName(), ForgeRegistries.ITEMS));
        KELP.add(0, RegistryObject.create(Items.KELP.getRegistryName(), ForgeRegistries.ITEMS));
        BAMBOO.add(0, RegistryObject.create(Items.BAMBOO.getRegistryName(), ForgeRegistries.ITEMS));
        BROWN_MUSHROOMS.add(0, RegistryObject.create(Items.BROWN_MUSHROOM.getRegistryName(), ForgeRegistries.ITEMS));
        RED_MUSHROOMS.add(0, RegistryObject.create(Items.RED_MUSHROOM.getRegistryName(), ForgeRegistries.ITEMS));
        CRIMSON_FUNGUS.add(0, RegistryObject.create(Items.CRIMSON_FUNGUS.getRegistryName(), ForgeRegistries.ITEMS));
        WARPED_FUNGUS.add(0, RegistryObject.create(Items.WARPED_FUNGUS.getRegistryName(), ForgeRegistries.ITEMS));
        WITHER_ROSES.add(0, RegistryObject.create(Items.WITHER_ROSE.getRegistryName(), ForgeRegistries.ITEMS));
        NETHER_WARTS.add(0, RegistryObject.create(Items.NETHER_WART.getRegistryName(), ForgeRegistries.ITEMS));
    }
}
