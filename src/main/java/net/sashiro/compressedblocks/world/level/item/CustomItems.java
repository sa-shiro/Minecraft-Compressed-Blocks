...
public class CustomItems {
    ...
    public static void populate() {
        ...
        APPLES.add(0, RegistryObject.create(resourceLocationFixer(Items.APPLE), ForgeRegistries.ITEMS));
        MUSHROOM_STEW.add(0, RegistryObject.create(resourceLocationFixer(Items.MUSHROOM_STEW), ForgeRegistries.ITEMS));
        BREAD.add(0, RegistryObject.create(resourceLocationFixer(Items.BREAD), ForgeRegistries.ITEMS));
        PORKCHOP.add(0, RegistryObject.create(resourceLocationFixer(Items.PORKCHOP), ForgeRegistries.ITEMS));
        COOKED_PORKCHOP.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKED_PORKCHOP), ForgeRegistries.ITEMS));
        COD.add(0, RegistryObject.create(resourceLocationFixer(Items.COD), ForgeRegistries.ITEMS));
        SALMON.add(0, RegistryObject.create(resourceLocationFixer(Items.SALMON), ForgeRegistries.ITEMS));
        TROPICAL_FISH.add(0, RegistryObject.create(resourceLocationFixer(Items.TROPICAL_FISH), ForgeRegistries.ITEMS));
        PUFFERFISH.add(0, RegistryObject.create(resourceLocationFixer(Items.PUFFERFISH), ForgeRegistries.ITEMS));
        COOKED_COD.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKED_COD), ForgeRegistries.ITEMS));
        COOKED_SALMON.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKED_SALMON), ForgeRegistries.ITEMS));
        CAKES.add(0, RegistryObject.create(resourceLocationFixer(Items.CAKE), ForgeRegistries.ITEMS));
        COOKIES.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKIE), ForgeRegistries.ITEMS));
        MELON_SLICES.add(0, RegistryObject.create(resourceLocationFixer(Items.MELON_SLICE), ForgeRegistries.ITEMS));
        MELON_SEEDS.add(0, RegistryObject.create(resourceLocationFixer(Items.MELON_SEEDS), ForgeRegistries.ITEMS));
        DRIED_KELP.add(0, RegistryObject.create(resourceLocationFixer(Items.DRIED_KELP), ForgeRegistries.ITEMS));
        BEEF.add(0, RegistryObject.create(resourceLocationFixer(Items.BEEF), ForgeRegistries.ITEMS));
        COOKED_BEEF.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKED_BEEF), ForgeRegistries.ITEMS));
        CHICKEN.add(0, RegistryObject.create(resourceLocationFixer(Items.CHICKEN), ForgeRegistries.ITEMS));
        COOKED_CHICKEN.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKED_CHICKEN), ForgeRegistries.ITEMS));
        ROTTEN_FLESH.add(0, RegistryObject.create(resourceLocationFixer(Items.ROTTEN_FLESH), ForgeRegistries.ITEMS));
        CARROTS.add(0, RegistryObject.create(resourceLocationFixer(Items.CARROT), ForgeRegistries.ITEMS));
        POTATOES.add(0, RegistryObject.create(resourceLocationFixer(Items.POTATO), ForgeRegistries.ITEMS));
        BAKED_POTATOES.add(0, RegistryObject.create(resourceLocationFixer(Items.BAKED_POTATO), ForgeRegistries.ITEMS));
        POISONOUS_POTATOES.add(0, RegistryObject.create(resourceLocationFixer(Items.POISONOUS_POTATO), ForgeRegistries.ITEMS));
        PUMPKIN_PIES.add(0, RegistryObject.create(resourceLocationFixer(Items.PUMPKIN_PIE), ForgeRegistries.ITEMS));
        RABBIT.add(0, RegistryObject.create(resourceLocationFixer(Items.RABBIT), ForgeRegistries.ITEMS));
        COOKED_RABBIT.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKED_RABBIT), ForgeRegistries.ITEMS));
        RABBIT_STEW.add(0, RegistryObject.create(resourceLocationFixer(Items.RABBIT_STEW), ForgeRegistries.ITEMS));
        MUTTON.add(0, RegistryObject.create(resourceLocationFixer(Items.MUTTON), ForgeRegistries.ITEMS));
        COOKED_MUTTON.add(0, RegistryObject.create(resourceLocationFixer(Items.COOKED_MUTTON), ForgeRegistries.ITEMS));
        BEETROOT.add(0, RegistryObject.create(resourceLocationFixer(Items.BEETROOT), ForgeRegistries.ITEMS));
        BEETROOT_SEEDS.add(0, RegistryObject.create(resourceLocationFixer(Items.BEETROOT_SEEDS), ForgeRegistries.ITEMS));
        BEETROOT_SOUP.add(0, RegistryObject.create(resourceLocationFixer(Items.BEETROOT_SOUP), ForgeRegistries.ITEMS));
        SWEET_BERRIES.add(0, RegistryObject.create(resourceLocationFixer(Items.SWEET_BERRIES), ForgeRegistries.ITEMS));
        GLOW_BERRIES.add(0, RegistryObject.create(resourceLocationFixer(Items.GLOW_BERRIES), ForgeRegistries.ITEMS));
        EGGS.add(0, RegistryObject.create(resourceLocationFixer(Items.EGG), ForgeRegistries.ITEMS));
        SUGAR_CANES.add(0, RegistryObject.create(resourceLocationFixer(Items.SUGAR_CANE), ForgeRegistries.ITEMS));
        SUGAR.add(0, RegistryObject.create(resourceLocationFixer(Items.SUGAR), ForgeRegistries.ITEMS));
        PUMPKINS.add(0, RegistryObject.create(resourceLocationFixer(Items.PUMPKIN), ForgeRegistries.ITEMS));
        PUMPKIN_SEEDS.add(0, RegistryObject.create(resourceLocationFixer(Items.PUMPKIN_SEEDS), ForgeRegistries.ITEMS));
        WHEAT.add(0, RegistryObject.create(resourceLocationFixer(Items.WHEAT), ForgeRegistries.ITEMS));
        WHEAT_SEEDS.add(0, RegistryObject.create(resourceLocationFixer(Items.WHEAT_SEEDS), ForgeRegistries.ITEMS));
        COCOA_BEANS.add(0, RegistryObject.create(resourceLocationFixer(Items.COCOA_BEANS), ForgeRegistries.ITEMS));
        ARROWS.add(0, RegistryObject.create(resourceLocationFixer(Items.ARROW), ForgeRegistries.ITEMS));
        SPIDER_EYES.add(0, RegistryObject.create(resourceLocationFixer(Items.SPIDER_EYE), ForgeRegistries.ITEMS));
        FERMENTED_SPIDER_EYES.add(0, RegistryObject.create(resourceLocationFixer(Items.FERMENTED_SPIDER_EYE), ForgeRegistries.ITEMS));
        BLAZE_RODS.add(0, RegistryObject.create(resourceLocationFixer(Items.BLAZE_ROD), ForgeRegistries.ITEMS));
        BLAZE_POWDER.add(0, RegistryObject.create(resourceLocationFixer(Items.BLAZE_POWDER), ForgeRegistries.ITEMS));
        MAGMA_CREAM.add(0, RegistryObject.create(resourceLocationFixer(Items.MAGMA_CREAM), ForgeRegistries.ITEMS));
        BONES.add(0, RegistryObject.create(resourceLocationFixer(Items.BONE), ForgeRegistries.ITEMS));
        BONE_MEAL.add(0, RegistryObject.create(resourceLocationFixer(Items.BONE_MEAL), ForgeRegistries.ITEMS));
        ENDER_EYES.add(0, RegistryObject.create(resourceLocationFixer(Items.ENDER_EYE), ForgeRegistries.ITEMS));
        ENDER_PEARLS.add(0, RegistryObject.create(resourceLocationFixer(Items.ENDER_PEARL), ForgeRegistries.ITEMS));
        FEATHERS.add(0, RegistryObject.create(resourceLocationFixer(Items.FEATHER), ForgeRegistries.ITEMS));
        LEATHER.add(0, RegistryObject.create(resourceLocationFixer(Items.LEATHER), ForgeRegistries.ITEMS));
        STRINGS.add(0, RegistryObject.create(resourceLocationFixer(Items.STRING), ForgeRegistries.ITEMS));
        INK_SACS.add(0, RegistryObject.create(resourceLocationFixer(Items.INK_SAC), ForgeRegistries.ITEMS));
        GLOW_INK_SACS.add(0, RegistryObject.create(resourceLocationFixer(Items.GLOW_INK_SAC), ForgeRegistries.ITEMS));
        STICKS.add(0, RegistryObject.create(resourceLocationFixer(Items.STICK), ForgeRegistries.ITEMS));
        GLASS_BOTTLES.add(0, RegistryObject.create(resourceLocationFixer(Items.GLASS_BOTTLE), ForgeRegistries.ITEMS));
        SNOWBALLS.add(0, RegistryObject.create(resourceLocationFixer(Items.SNOWBALL), ForgeRegistries.ITEMS));
        PAPER.add(0, RegistryObject.create(resourceLocationFixer(Items.PAPER), ForgeRegistries.ITEMS));
        FLINTS.add(0, RegistryObject.create(resourceLocationFixer(Items.FLINT), ForgeRegistries.ITEMS));
        OAK_SAPLINGS.add(0, RegistryObject.create(resourceLocationFixer(Items.OAK_SAPLING), ForgeRegistries.ITEMS));
        SPRUCE_SAPLINGS.add(0, RegistryObject.create(resourceLocationFixer(Items.SPRUCE_SAPLING), ForgeRegistries.ITEMS));
        BIRCH_SAPLINGS.add(0, RegistryObject.create(resourceLocationFixer(Items.BIRCH_SAPLING), ForgeRegistries.ITEMS));
        JUNGLE_SAPLINGS.add(0, RegistryObject.create(resourceLocationFixer(Items.JUNGLE_SAPLING), ForgeRegistries.ITEMS));
        ACACIA_SAPLINGS.add(0, RegistryObject.create(resourceLocationFixer(Items.ACACIA_SAPLING), ForgeRegistries.ITEMS));
        DARK_OAK_SAPLINGS.add(0, RegistryObject.create(resourceLocationFixer(Items.DARK_OAK_SAPLING), ForgeRegistries.ITEMS));
        CHORUS_FRUITS.add(0, RegistryObject.create(resourceLocationFixer(Items.CHORUS_FRUIT), ForgeRegistries.ITEMS));
        SEAGRASS.add(0, RegistryObject.create(resourceLocationFixer(Items.SEAGRASS), ForgeRegistries.ITEMS));
        KELP.add(0, RegistryObject.create(resourceLocationFixer(Items.KELP), ForgeRegistries.ITEMS));
        BAMBOO.add(0, RegistryObject.create(resourceLocationFixer(Items.BAMBOO), ForgeRegistries.ITEMS));
        BROWN_MUSHROOMS.add(0, RegistryObject.create(resourceLocationFixer(Items.BROWN_MUSHROOM), ForgeRegistries.ITEMS));
        RED_MUSHROOMS.add(0, RegistryObject.create(resourceLocationFixer(Items.RED_MUSHROOM), ForgeRegistries.ITEMS));
        CRIMSON_FUNGUS.add(0, RegistryObject.create(resourceLocationFixer(Items.CRIMSON_FUNGUS), ForgeRegistries.ITEMS));
        WARPED_FUNGUS.add(0, RegistryObject.create(resourceLocationFixer(Items.WARPED_FUNGUS), ForgeRegistries.ITEMS));
        WITHER_ROSES.add(0, RegistryObject.create(resourceLocationFixer(Items.WITHER_ROSE), ForgeRegistries.ITEMS));
        NETHER_WARTS.add(0, RegistryObject.create(resourceLocationFixer(Items.NETHER_WART), ForgeRegistries.ITEMS));
    }

    private static ResourceLocation resourceLocationFixer(Item item) {
        String str = item.getDescriptionId().replace("item.minecraft.", "");
