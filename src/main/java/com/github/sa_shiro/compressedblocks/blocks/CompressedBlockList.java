...
public class CompressedBlockList {
    ...
    public static class Single {
        ...
        public static CompressedBlock COMPRESSED_ANDESITE;
    ...
    public static class Triple {
        ...
        @ObjectHolder(tripleCompression + "diorite")
        public static CompressedBlock TRIPLE_COMPRESSED_DIORITE;
        @ObjectHolder(tripleCompression + "andesite")
        public static CompressedBlock TRIPLE_COMPRESSED_ANDESITE;
        @ObjectHolder(tripleCompression + "dirt")
        public static CompressedBlock TRIPLE_COMPRESSED_DIRT;
        @ObjectHolder(tripleCompression + "cobblestone")
        public static CompressedBlock TRIPLE_COMPRESSED_COBBLESTONE;
        @ObjectHolder(tripleCompression + "sand")
        public static CompressedBlock TRIPLE_COMPRESSED_SAND;
        @ObjectHolder(tripleCompression + "red_sand")
        public static CompressedBlock TRIPLE_COMPRESSED_RED_SAND;
        @ObjectHolder(tripleCompression + "gravel")
        public static CompressedBlock TRIPLE_COMPRESSED_GRAVEL;
        @ObjectHolder(tripleCompression + "netherrack")
    ...
    public static class Quad {
        ...
        public static CompressedBlock QUADRUPLE_COMPRESSED_DIORITE;
        @ObjectHolder(quadCompression + "andesite")
        public static CompressedBlock QUADRUPLE_COMPRESSED_ANDESITE;
        @ObjectHolder(quadCompression + "dirt")
        public static CompressedBlock QUADRUPLE_COMPRESSED_DIRT;
        @ObjectHolder(quadCompression + "cobblestone")
        public static CompressedBlock QUADRUPLE_COMPRESSED_COBBLESTONE;
        @ObjectHolder(quadCompression + "sand")
    ...
    public static class Quin {
        ...
        public static CompressedBlock QUINTUPLE_COMPRESSED_DIORITE;
        @ObjectHolder(quinCompression + "andesite")
        public static CompressedBlock QUINTUPLE_COMPRESSED_ANDESITE;
        @ObjectHolder(quinCompression + "dirt")
        public static CompressedBlock QUINTUPLE_COMPRESSED_DIRT;
        @ObjectHolder(quinCompression + "cobblestone")
    ...
    public static class Sext {
        ...
        public static CompressedBlock SEXTUPLE_COMPRESSED_DIORITE;
        @ObjectHolder(sexCompression + "andesite")
        public static CompressedBlock SEXTUPLE_COMPRESSED_ANDESITE;
        @ObjectHolder(sexCompression + "dirt")
        public static CompressedBlock SEXTUPLE_COMPRESSED_DIRT;
        @ObjectHolder(sexCompression + "cobblestone")
