...
public class Lists {
    ...
    public static final BlockFactory NETHERRACK = new BlockFactory(BlockType.DEFAULT, "netherrack", Material.ROCK, MaterialColor.NETHERRACK, SoundType.STONE);
    public static final BlockFactory NETHER_BRICKS = new BlockFactory(BlockType.DEFAULT, "nether_bricks", Material.EARTH, MaterialColor.NETHERRACK, SoundType.STONE);
    public static final BlockFactory RED_NETHER_BRICKS = new BlockFactory(BlockType.DEFAULT, "red_nether_bricks", Material.EARTH, MaterialColor.NETHERRACK, SoundType.STONE);
    ...
    public static final BlockFactory SOUL_SAND = new BlockFactory(BlockType.SOUL_SAND, "soul_sand", Material.SAND, MaterialColor.BROWN, SoundType.SAND);
