...
public class DeferredRegistryEvent {
    ...
    protected static final DeferredRegister<Block> BLOCKS = new DeferredRegister<>(ForgeRegistries.BLOCKS, CompressedBlocks.MOD_ID);
    protected static final DeferredRegister<Item> ITEMS = new DeferredRegister<>(ForgeRegistries.ITEMS, CompressedBlocks.MOD_ID);
