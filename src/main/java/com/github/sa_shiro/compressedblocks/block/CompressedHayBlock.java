...
public class CompressedHayBlock extends HayBlock {
     ...
     */
    public CompressedHayBlock(Material material, SoundType sound, int compression, float hardness, float resistance, int harvestLevel) {
