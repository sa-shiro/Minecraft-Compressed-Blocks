...
public class CompressedSoulSandBlock extends SoulSandBlock {
     ...
     */
    public CompressedSoulSandBlock(Material material, SoundType sound, int compression, float hardness, float resistance, int harvestLevel) {
