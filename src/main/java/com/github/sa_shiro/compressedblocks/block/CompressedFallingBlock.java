...
public class CompressedFallingBlock {

    public static class Sand extends SandBlock {
         ...
         */
        public Sand(Material material, SoundType sound, int compression, float hardness, float resistance, int harvestLevel) {
            super(1, Properties.create(material)
                    .sound(sound)
        ...
        public void addInformation(ItemStack stack, @Nullable IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
            ...
            tooltip.add(new StringTextComponent(blockCount + " Blocks").func_240699_a_(color));
        }
    }

    public static class Gravel extends GravelBlock {
        private String blockCount;
        private TextFormatting color;
         ...
         * @param harvestLevel Block harvest level          0: Wood, 1: Stone/Gold, 2: Iron, 3: Diamond
         */
        public Gravel(Material material, SoundType sound, int compression, float hardness, float resistance, int harvestLevel) {
