 ...
 */
class CompressedGravel extends GravelBlock implements ICompressedBlock {
    ...
    protected CompressedGravel(Material material, MaterialColor materialColor, SoundType sound, int compression, float hardness, float resistance, int harvestLevel) {
    ...
    public void addInformation(@Nonnull ItemStack stack, @Nullable IBlockReader worldIn, @Nonnull List<ITextComponent> tooltip, @Nonnull ITooltipFlag flagIn) {
        ...
        tooltip.add(new StringTextComponent(comp.getBlockCount() + " Blocks").applyTextStyle(comp.getTextFormatting()));
    }
