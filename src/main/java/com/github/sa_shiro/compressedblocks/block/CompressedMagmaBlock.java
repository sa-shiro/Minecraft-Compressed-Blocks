...
public class CompressedMagmaBlock extends MagmaBlock {
     ...
     */
    public CompressedMagmaBlock(Material material, SoundType sound, int compression, float hardness, float resistance, int harvestLevel) {
