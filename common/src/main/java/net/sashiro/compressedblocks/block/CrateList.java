...
public class CrateList {
    private static final BlockBehaviour.Properties p0 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[0], RESISTANCE[0]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p1 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[1], RESISTANCE[1]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p2 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[2], RESISTANCE[2]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p3 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[3], RESISTANCE[3]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p4 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[4], RESISTANCE[4]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p5 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[5], RESISTANCE[5]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p6 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[6], RESISTANCE[6]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p7 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[7], RESISTANCE[7]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p8 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[8], RESISTANCE[8]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
    private static final BlockBehaviour.Properties p9 = BlockBehaviour.Properties.of(Material.WOOD).strength(HARDNESS[9], RESISTANCE[9]).color(MaterialColor.COLOR_BROWN).sound(SoundType.WOOD);
