...
public class BlockList {
    ...
    public static CBBlock[] createBlocks(String name, Float amplifier, boolean hasSmallerCompression) {
        ...
        for (int i = 0; i < MAX_COMPRESSION_LEVEL; i++) {
            if (!CommonUtils.isEnabled(name)) continue;
            ...
            result[i] = new CBBlock(BlockBehaviour.Properties.of().strength(blockHardness, blockResistance), i, hasSmallerCompression);
        }
        return result;
    }
