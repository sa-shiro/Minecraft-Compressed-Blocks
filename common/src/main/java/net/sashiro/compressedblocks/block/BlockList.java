...
public class BlockList {
    ...
    // ==================================================
    // COPPER_BLOCK
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock COPPER_BLOCK_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.COPPER_BLOCK).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // CUT_COPPER
    public static final CustomWeatheringCopperBlock CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // EXPOSED_COPPER
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock EXPOSED_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // EXPOSED_CUT_COPPER
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock EXPOSED_CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.EXPOSED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WEATHERED_COPPER
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WEATHERED_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WEATHERED_CUT_COPPER
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WEATHERED_CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WEATHERED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // OXIDIZED_COPPER
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock OXIDIZED_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // OXIDIZED_CUT_COPPER
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock OXIDIZED_CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.OXIDIZED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_COPPER_BLOCK
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_COPPER_BLOCK_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_COPPER_BLOCK).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_CUT_COPPER
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.UNAFFECTED, BlockBehaviour.Properties.copy(Blocks.WAXED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_EXPOSED_COPPER
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_EXPOSED_CUT_COPPER
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_EXPOSED_CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.EXPOSED, BlockBehaviour.Properties.copy(Blocks.WAXED_EXPOSED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_WEATHERED_COPPER
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_WEATHERED_CUT_COPPER
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_WEATHERED_CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.WEATHERED, BlockBehaviour.Properties.copy(Blocks.WAXED_WEATHERED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_OXIDIZED_COPPER
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
    // WAXED_OXIDIZED_CUT_COPPER
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_0 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 0);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_1 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[2], RESISTANCE[0]), 1);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_2 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 2);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_3 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[3], RESISTANCE[1]), 3);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_4 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 4);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_5 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[4], RESISTANCE[2]), 5);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_6 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 6);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_7 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[5], RESISTANCE[3]), 7);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_8 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 8);
    public static final CustomWeatheringCopperBlock WAXED_OXIDIZED_CUT_COPPER_9 = new CustomWeatheringCopperBlock(WeatheringCopper.WeatherState.OXIDIZED, BlockBehaviour.Properties.copy(Blocks.WAXED_OXIDIZED_CUT_COPPER).strength(HARDNESS[6], RESISTANCE[4]), 9);
}
