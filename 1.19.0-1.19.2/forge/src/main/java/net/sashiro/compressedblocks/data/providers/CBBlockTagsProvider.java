...
public class CBBlockTagsProvider extends BlockTagsProvider {
    ...
    public CBBlockTagsProvider(DataGenerator generator, CompletableFuture<HolderLookup.Provider> lookupProvider, String modId, @Nullable ExistingFileHelper existingFileHelper) {
        super(generator, lookupProvider, modId, existingFileHelper);
    }
