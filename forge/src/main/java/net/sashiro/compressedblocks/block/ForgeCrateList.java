...
public class ForgeCrateList {
    private static final AbstractBlock.Properties p0 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[0], RESISTANCE[0]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p1 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[1], RESISTANCE[1]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p2 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[2], RESISTANCE[2]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p3 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[3], RESISTANCE[3]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p4 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[4], RESISTANCE[4]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p5 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[5], RESISTANCE[5]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p6 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[6], RESISTANCE[6]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p7 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[7], RESISTANCE[7]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p8 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[8], RESISTANCE[8]).sound(SoundType.WOOD);
    private static final AbstractBlock.Properties p9 = AbstractBlock.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[9], RESISTANCE[9]).sound(SoundType.WOOD);
