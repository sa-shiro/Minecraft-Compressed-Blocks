...
import static net.sashiro.compressedblocks.block.CompressedBlock.*;
...
public class CBBlocks {
    ...
    //region MUD
    //------------------------------------------------------------------------------------------------------------------
    public static final RegistryObject<Block> MUD_0 = BLOCKS.register("c0_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[2], RESISTANCE[0]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 0));
    public static final RegistryObject<Block> MUD_1 = BLOCKS.register("c1_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[2], RESISTANCE[0]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 1));
    public static final RegistryObject<Block> MUD_2 = BLOCKS.register("c2_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[3], RESISTANCE[1]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 2));
    public static final RegistryObject<Block> MUD_3 = BLOCKS.register("c3_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[3], RESISTANCE[1]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 3));
    public static final RegistryObject<Block> MUD_4 = BLOCKS.register("c4_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[4], RESISTANCE[2]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 4));
    public static final RegistryObject<Block> MUD_5 = BLOCKS.register("c5_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[4], RESISTANCE[2]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 5));
    public static final RegistryObject<Block> MUD_6 = BLOCKS.register("c6_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[5], RESISTANCE[3]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 6));
    public static final RegistryObject<Block> MUD_7 = BLOCKS.register("c7_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[5], RESISTANCE[3]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 7));
    public static final RegistryObject<Block> MUD_8 = BLOCKS.register("c8_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[6], RESISTANCE[4]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 8));
    public static final RegistryObject<Block> MUD_9 = BLOCKS.register("c9_" + "MUD".toLowerCase(), () -> new CustomMudBlock(BlockBehaviour.Properties.copy(Blocks.MUD).strength(HARDNESS[6], RESISTANCE[4]).mapColor(MapColor.TERRACOTTA_CYAN).isValidSpawn(CBBlocks::isTrue).isRedstoneConductor(CBBlocks::isTrue).isViewBlocking(CBBlocks::isTrue).isSuffocating(CBBlocks::isTrue).sound(SoundType.MUD), 9));
    //------------------------------------------------------------------------------------------------------------------
    //endregion
    //------------------------------------------------------------------------------------------------------------------
    //region OAK_LOG
