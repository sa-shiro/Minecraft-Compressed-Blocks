...
public class ForgeCompression {
    ...
    public void setCompressionLevel(int compressionLevel) {
        ...
        switch (compressionLevel) {
            case 0:
                this.blockCount = "9";
                this.style = style.setColor(TextFormatting.WHITE);
                break;
            case 1:
                this.blockCount = "81";
                this.style = style.setColor(TextFormatting.YELLOW);
                break;
            case 2:
                this.blockCount = "729";
                this.style = style.setColor(TextFormatting.YELLOW);
            ...
            case 4:
                ...
                this.style = style.setColor(TextFormatting.AQUA);
                break;
            case 5:
            ...
            case 6:
                ...
                this.style = style.setColor(TextFormatting.LIGHT_PURPLE);
                break;
            case 7:
                this.blockCount = "43.046.721";
                this.style = style.setColor(TextFormatting.DARK_PURPLE);
                break;
            case 8:
                this.blockCount = "387.420.489";
                this.style = style.setColor(TextFormatting.RED);
                break;
            case 9:
                this.blockCount = "3.486.784.101";
                this.style = style.setColor(TextFormatting.DARK_RED);
                break;
        }
    }
