...
public class CBRecipeProvider extends RecipeProvider {
    ...
    private void makeShapedRecipe(Consumer<FinishedRecipe> exporter, RecipeCategory recipeCategory, ItemLike result, ItemLike ingredient, String fileName) {
    ...
    private void makeShapelessRecipe(Consumer<FinishedRecipe> exporter, RecipeCategory recipeCategory, ItemLike result, ItemLike ingredient, String recipeName) {
        CBBlock compressedBlock = getCbBlock(result, ingredient);
