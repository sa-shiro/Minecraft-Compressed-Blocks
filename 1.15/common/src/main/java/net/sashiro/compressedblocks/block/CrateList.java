...
public class CrateList {
    private static final Block.Properties p0 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[0], RESISTANCE[0]);
    private static final Block.Properties p1 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[1], RESISTANCE[1]);
    private static final Block.Properties p2 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[2], RESISTANCE[2]);
    private static final Block.Properties p3 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[3], RESISTANCE[3]);
    private static final Block.Properties p4 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[4], RESISTANCE[4]);
    private static final Block.Properties p5 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[5], RESISTANCE[5]);
    private static final Block.Properties p6 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[6], RESISTANCE[6]);
    private static final Block.Properties p7 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[7], RESISTANCE[7]);
    private static final Block.Properties p8 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[8], RESISTANCE[8]);
    private static final Block.Properties p9 = Block.Properties.of(Material.WOOD, MaterialColor.COLOR_BROWN).strength(HARDNESS[9], RESISTANCE[9]);
