...
public class ForgeCrateList {
    private static final Block.Properties p0 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[0], RESISTANCE[0]).sound(SoundType.WOOD);
    private static final Block.Properties p1 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[1], RESISTANCE[1]).sound(SoundType.WOOD);
    private static final Block.Properties p2 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[2], RESISTANCE[2]).sound(SoundType.WOOD);
    private static final Block.Properties p3 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[3], RESISTANCE[3]).sound(SoundType.WOOD);
    private static final Block.Properties p4 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[4], RESISTANCE[4]).sound(SoundType.WOOD);
    private static final Block.Properties p5 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[5], RESISTANCE[5]).sound(SoundType.WOOD);
    private static final Block.Properties p6 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[6], RESISTANCE[6]).sound(SoundType.WOOD);
    private static final Block.Properties p7 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[7], RESISTANCE[7]).sound(SoundType.WOOD);
    private static final Block.Properties p8 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[8], RESISTANCE[8]).sound(SoundType.WOOD);
    private static final Block.Properties p9 = Block.Properties.create(Material.WOOD, MaterialColor.BROWN).hardnessAndResistance(HARDNESS[9], RESISTANCE[9]).sound(SoundType.WOOD);
