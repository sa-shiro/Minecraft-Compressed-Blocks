...
import static net.sashiro.compressedblocks.block.ForgeBlockList.*;
...
public class CBBlockRegister {
    ...
    private static void registerBlock(String name, Block block) {
        ...
        ITEMS.register(name.toLowerCase(), () -> new BlockItem(block, new Item.Properties().group(ItemGroups.compressedBlockGroup)));
