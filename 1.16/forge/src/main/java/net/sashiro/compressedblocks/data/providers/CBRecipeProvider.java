...
import static net.sashiro.compressedblocks.event.CBRegistryEvent.BLOCK_LIST;
import static net.sashiro.compressedblocks.event.CBRegistryEvent.CRATE_LIST;
...
public class CBRecipeProvider extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(Consumer<IFinishedRecipe> consumer) {
        ArrayList<Block> blocks = (ArrayList<Block>) BLOCK_LIST;
        ...
        ArrayList<Block> crate_items = (ArrayList<Block>) CRATE_LIST;
